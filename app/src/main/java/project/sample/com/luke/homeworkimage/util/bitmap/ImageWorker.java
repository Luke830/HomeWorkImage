...
//            if (BuildConfig.DEBUG) {
//                final Object bitmapData = bitmapWorkerTask.mData;
//                MyLog.e("cancelWork - cancelled work for " + bitmapData);
//            }
//        }
//    }
//
...
//            if (bitmapData == null || !bitmapData.equals(data)) {
//                bitmapWorkerTask.cancel(true);
//                MyLog.e("cancelPotentialWork - cancelled work for " + data);
//            } else {
//                // The same work is already in progress.
//                return false;
//            }
...
//            // BEGIN_INCLUDE(load_bitmap_in_background)
//            MyLog.d("doInBackground - starting work");
//
//            mData = params[0];
//            final String dataString = String.valueOf(mData);
//            Bitmap bitmap = null;
...
//            }
//
//            MyLog.d(TAG, "doInBackground - finished work");
//
//            return drawable;
//            // END_INCLUDE(load_bitmap_in_background)
//        }
...
//
//            final ImageView imageView = getAttachedImageView();
//            MyLog.d("onPostExecute imageView = " + imageView + " value = " + value);
//            if (value != null && imageView != null) {
//                if (BuildConfig.DEBUG) {
//                    MyLog.d("onPostExecute - setting bitmap");
//                }
//                setImageDrawable(imageView, value);
//            }
//            // END_INCLUDE(complete_background_work)
