...
//
//    /**
//     * Create a new ImageCache object using the specified parameters. This should not be called directly by other classes, instead use {@link ImageCache#getInstance(FragmentManager, ImageCacheParams)} to fetch an ImageCache instance.
//     *
//     * @param cacheParams The cache parameters to use to initialize the cache
//     */
//    private ImageCache(ImageCacheParams cacheParams) {
...
//
//        /**
//         * Create a set of image cache parameters that can be provided to {@link ImageCache#getInstance(FragmentManager, ImageCacheParams)} or {@link ImageWorker#addImageCache(FragmentManager, ImageCacheParams)}.
//         *
//         * @param context                A context to use.
