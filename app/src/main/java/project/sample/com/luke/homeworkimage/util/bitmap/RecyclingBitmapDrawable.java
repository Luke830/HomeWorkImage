...
//
///**
// * A BitmapDrawable that keeps track of whether it is being displayed or cached. When the drawable is no longer being displayed or cached, {@link Bitmap#recycle() recycle()} will be called on this drawable's bitmap.
// */
//public class RecyclingBitmapDrawable extends BitmapDrawable {
//
//    static final String TAG = "CountingBitmapDrawable";
...
//            MyLog.e("No longer being used or cached so recycling. " + toString());
//
//            getBitmap().recycle();
//        }
//        // END_INCLUDE(check_state)
