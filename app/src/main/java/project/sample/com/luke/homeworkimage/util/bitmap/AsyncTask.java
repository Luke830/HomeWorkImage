...
public abstract class AsyncTask<Params, Progress, Result> {
     ...
     */
    public static final Executor SERIAL_EXECUTOR = DataUtil.hasHoneycomb() ? new SerialExecutor() :
...
//
///**
// * ************************************* Copied from JB release framework: https://android.googlesource.com/platform/frameworks/base/+/jb-release/core/java/android/os/AsyncTask.java
// * <p/>
...
// * <p/>
// * <p>
// * AsyncTask is designed to be a helper class around {@link Thread} and {@link Handler} and does not constitute a generic threading framework. AsyncTasks should ideally be used for short operations (a few seconds at the most.) If you need to keep threads running for long periods of time, it is highly recommended you use the various APIs provided by the <code>java.util.concurrent</code> pacakge such as {@link Executor},
// * {@link ThreadPoolExecutor} and {@link FutureTask}.
// * </p>
// * <p/>
// * <p>
// * An asynchronous task is defined by a computation that runs on a background thread and whose result is published on the UI thread. An asynchronous task is defined by 3 generic types, called <code>Params</code>, <code>Progress</code> and <code>Result</code>, and 4 steps, called <code>onPreExecute</code>, <code>doInBackground</code>, <code>onProgressUpdate</code> and <code>onPostExecute</code>.
// * </p>
// * <p/>
...
//     */
//    public static final Executor SERIAL_EXECUTOR = DataUtil.hasHoneycomb() ? new SerialExecutor() : Executors.newSingleThreadExecutor(sThreadFactory);
//
...
//     * <p/>
//     * <p/>
//     * Note: this function schedules the task on a queue for a single background thread or pool of threads depending on the platform version. When first introduced, AsyncTasks were executed serially on a single background thread. Starting with {@link android.os.Build.VERSION_CODES#DONUT}, this was changed to a pool of threads allowing multiple tasks to operate in parallel. Starting {@link android.os.Build.VERSION_CODES#HONEYCOMB}, tasks are back to being executed on a single thread to avoid
//     * common application errors caused by parallel execution. If you truly want parallel execution, you can use the {@link #executeOnExecutor} version of this method with {@link #THREAD_POOL_EXECUTOR}; however, see commentary there for warnings on its use.
//     * <p/>
//     * <p/>
