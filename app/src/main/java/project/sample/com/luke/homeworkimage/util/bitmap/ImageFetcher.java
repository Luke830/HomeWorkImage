...
//                try {
//                    mHttpDiskCache = DiskLruCache.open(mHttpCacheDir, 1, 1, HTTP_CACHE_SIZE);
//                    MyLog.d("HTTP cache initialized");
//                } catch (IOException e) {
//                    mHttpDiskCache = null;
//                }
//            }
...
//                try {
//                    mHttpDiskCache.delete();
//                    MyLog.d("HTTP cache cleared");
//                } catch (IOException e) {
//                    MyLog.e("clearCacheInternal - " + e);
//                }
//                mHttpDiskCache = null;
//                mHttpDiskCacheStarting = true;
//                initHttpDiskCache();
...
//                        mHttpDiskCache.close();
//                        mHttpDiskCache = null;
//                        MyLog.e("HTTP cache closed");
//                    }
//                } catch (IOException e) {
//                    MyLog.e("closeCacheInternal - " + e);
//                }
//            }
//        }
//    }
...
//            MyLog.e("checkConnection - no connection found");
//        }
//    }
//
//    /**
...
//                    snapshot = mHttpDiskCache.get(key);
//                    if (snapshot == null) {
//                        MyLog.d("processBitmap, not found in http cache, downloading...");
//                        DiskLruCache.Editor editor = mHttpDiskCache.edit(key);
//                        if (editor != null) {
//                            if (downloadUrlToStream(data, editor.newOutputStream(DISK_CACHE_INDEX))) {
//                                editor.commit();
//                                MyLog.e("download compelete - " + data);
//                            } else {
//                                editor.abort();
//                            }
//                        }
...
//            return true;
//        } catch (final IOException e) {
//            MyLog.e("Error in downloadBitmap - " + e);
//        } finally {
//            if (urlConnection != null) {
//                urlConnection.disconnect();
//            }
